...
import styles from "./subnavbr.module.css"

const Subnavbar = () => {
  return (
    <div className="max-width">
       <div className={styles.cccdiv}>
        <div>
          <img
            style={{ height: "80px" }}
        ...
        <div>
          <img
            style={{ height: "80px" }}
            src="https://dao54xqhg9jfa.cloudfront.net/OMS-Category/2569efa2-90ca-533c-e7c2-48330c4b3a59/original/Circle@3x-21.png?format=webp"
            alt=""
          />
          <p>Cold Cuts</p>
        </div>
        ...
        <div>
          <img
            style={{ height: "80px" }}
            src="https://dao54xqhg9jfa.cloudfront.net/OMS-Category/fc961d16-990b-31de-e3ec-648858625bed/original/v_copy_3@3x_(2).png?format=webp"
            alt=""
          />
          <p>Lunchbox</p>
        </div>
